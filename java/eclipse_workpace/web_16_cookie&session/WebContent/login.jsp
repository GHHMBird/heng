		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<form class="form-horizontal" action="/web_16_cookie&session/login" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" id="inputPassword3" name="yanzhengma"
									placeholder="请输入验证码">
							</div>
							<div class="col-sm-3">
								<img src="/web_16_cookie&session/checkImg" />
							</div>
						</div>
						<div class="form-group">
