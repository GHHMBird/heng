...
import hhm.jdbc.DataSource.MyDataSource;
import hhm.jdbc.utils.C3P0Utils;
import hhm.jdbc.utils.DBCPUtils;

public class TestJunit {
	
	@Test
	public void testTestJunit() throws Exception {
		hhm.jdbc.DataSource.TestJunit dataSource = new hhm.jdbc.DataSource.TestJunit();
		Connection connection = dataSource.getConnection();
		PreparedStatement statement = connection.prepareStatement("insert into product values(null,?,?,?)");
		statement.setString(1, "hhm");
		statement.setDouble(2, 100);
		statement.setString(3, "c004");
		statement.executeUpdate();
		if (statement!=null) {
			statement.close();
		}
		if (connection!=null) {
			dataSource.returnQueen(connection);
		}
	}
	
	@Test
	public void testMyConnection() throws Exception {
	...
	@Test
	public void testC3P0Utils() throws Exception {
	...
	public void testAdd() throws Exception {
		Connection connection = C3P0Utils.getConnection();
		PreparedStatement statement = connection.prepareStatement("INSERT INTO `product` VALUES ('1','小米 4c 标准版',1399,1299,'products/1/c_0001.jpg','2015-11-02',1,'小米 4c 标准版 全网通 白色 移动联通电信4G手机 双卡双待',0,'1'),\r\n" + 
				...
				"('50','Apple iPad Air 2 MGLW2CH/A',2399,2299,'products/1/c_0050.jpg','2015-11-12',0,'（9.7英寸 16G WLAN 机型 银色）',0,'2'),('6','魅族 MX5 16GB 银黑色',1899,1799,'products/1/c_0006.jpg','2015-11-02',0,'魅族 MX5 16GB 银黑色 移动联通双4G手机 双卡双待送原厂钢化膜+保护壳+耳机！5.5英寸大屏幕，3G运行内存，2070万+500万像素摄像头！长期省才是真的省！',0,'1'),\r\n" + 
	...
	@Test
	public void testDBCPUtils() throws Exception {
