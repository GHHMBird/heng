...
<body>
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		...
		<c:if test="${bean.currentPage!=1 }">
			<li >
			<a href="${pageContext.request.contextPath}/productPageList?currentPage=${bean.currentPage-1}" aria-label="Previous">
				<span aria-hidden="true">&laquo;</span>
			</a>
		</li>
		</c:if>
			<c:forEach begin="1" end="${bean.totalPage }" var="page">
				...
				<c:if test="${bean.currentPage!=page }">
					<li><a href="${pageContext.request.contextPath}/productPageList?currentPage=${page}">${page}</a></li>
				</c:if>
			</c:forEach>
			...
			<c:if test="${bean.currentPage!=bean.totalPage }">
				<li>
					<a href="${pageContext.request.contextPath}/productPageList?currentPage=${bean.currentPage+1}" aria-label="Next">
						 <span aria-hidden="true">&raquo;</span>
					</a>
				</li>
			</c:if>
