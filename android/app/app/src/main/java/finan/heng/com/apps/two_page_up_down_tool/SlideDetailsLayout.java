package finan.heng.com.apps.two_page_up_down_tool;
...
import static finan.heng.com.apps.two_page_up_down_tool.SlideDebug.DEBUG;
...
public class SlideDetailsLayout extends ViewGroup {
        ...
        switch (aciton) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (canChildScrollVertically((int) yDiff)) {
                    shouldIntercept = false;
                    if (DEBUG) {
                        Log.d("hhm", "intercept, child can scroll vertically, do not intercept");
                    }
                } else {
                    ...
                    if (yDiffabs > mTouchSlop && yDiffabs >= xDiffabs
                        ...
                        if (DEBUG) {
                            Log.d("hhm", "intercept, intercept events");
                        }
                    }
                }
                break;
    ...
    private void finishTouchEvent() {
        ...
        if (DEBUG) {
            Log.v("hhm", "finish, offset: " + offset + ", percent: " + percent + ", yVelocity: " + yVelocity);
        }
