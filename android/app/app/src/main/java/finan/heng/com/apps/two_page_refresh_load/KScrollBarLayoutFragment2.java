...
public class KScrollBarLayoutFragment2 extends BaseFragment {
    ...
    public KScrollBarLayoutFragment2(SetNumberListener listener) {
    ...
    public void refreshFinish() {
        ((BaseActivity) getActivity()).refreshFinish();
    }
